    ...
    <div class="p-6 min-h-full">
        ...
        <div class="mb-6">
            ...
            <nav class="flex items-center gap-1.5 text-sm text-slate-500">
                <a href="{{ route('crm.contacts.import') }}" class="hover:text-primary-600 transition-colors">Excel
                    upload</a>
                <svg class="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
                <span class="font-medium text-slate-700">Import type</span>
            </nav>
        </div>
                            ...
                            <div id="uploadTypePanel"
                                ...
                                <ul class="py-2 px-2">
                                    <li class="upload-type-option flex items-center px-3 py-2.5 text-sm text-slate-700 hover:bg-blue-600 hover:text-white cursor-pointer rounded-md transition-colors duration-100"
                                        data-value="create" data-label="Create new contacts">Create new contacts</li>
                                    <li class="upload-type-option flex items-center px-3 py-2.5 text-sm text-slate-700 hover:bg-blue-600 hover:text-white cursor-pointer rounded-md transition-colors duration-100"
                                        data-value="update" data-label="Update existing contacts">Update existing contacts
                                    </li>
                                    <li class="upload-type-option flex items-center px-3 py-2.5 text-sm text-slate-700 hover:bg-blue-600 hover:text-white cursor-pointer rounded-md transition-colors duration-100"
                                        data-value="both" data-label="Create &amp; update contacts">Create &amp; update
                                        contacts</li>
                                </ul>
                            </div>
                        </div>
