                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            @if($grade->status == 1)
                                            <button type="button" class="btn btn-outline-secondary btn-sm btnStatus" data-id="{{ $grade->idtbl_color_grade }}" title="Active – click to deactivate"><i class="fas fa-toggle-on"></i></button>
                                            @else
                                            <button type="button" class="btn btn-outline-warning btn-sm btnStatus" data-id="{{ $grade->idtbl_color_grade }}" title="Inactive – click to activate"><i class="fas fa-toggle-off"></i></button>
                                            @endif
                                            <button type="button" class="btn btn-outline-danger btn-sm btnDelete" data-id="{{ $grade->idtbl_color_grade }}" title="Delete">
