...
<div class="p-6 min-h-screen bg-slate-50">
    ...
    {{-- Filter Section --}}
    <div class="bg-white rounded-2xl border border-slate-200 p-5 mb-6 shadow-sm negative-inventory-filter-card">
        ...
        <div class="flex flex-wrap lg:flex-nowrap items-end gap-3 w-full">
            <div class="w-full lg:w-64 flex-shrink-0">
                ...
                <div class="relative" id="statusDropdownWrapper">
                    ...
                    <button type="button" id="statusDropdownBtn"
                        class="w-full flex items-center justify-between pl-3 pr-8 py-2.5 text-[13px] text-slate-500 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 cursor-pointer text-left hover:border-slate-400 transition-colors">
                    ...
                    <div id="statusDropdownPanel"
                        class="hidden absolute z-50 mt-1 w-full bg-white border border-slate-200 rounded-lg shadow-lg overflow-hidden">
                        <!-- Options list -->
            ...
            <div class="w-full lg:flex-1">
                ...
                <div class="flex items-center gap-2.5">
                    <div class="relative flex-1">
                        <input type="date"
                            class="filter-date w-full bg-white border border-slate-300 text-slate-700 py-2 px-3 rounded-xl text-[13px] focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-shadow">
                    </div>
            ...
            <div class="flex items-center gap-3 ml-auto flex-shrink-0">
                <button type="button" id="resetFiltersBtn" class="flex items-center justify-center w-[42px] h-[42px] bg-slate-100 text-[#1e3a8a] rounded-lg hover:bg-slate-200 transition-colors tooltip" title="Reset Filters">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                    </svg>
                </button>
                <button type="button" class="px-6 h-[42px] text-[14px] font-semibold text-white bg-[#2563eb] rounded-lg hover:bg-blue-700 shadow-sm transition-colors">
                    Apply
                </button>
            </div>
        </div>
        ...
        <div id="pending-tab" class="tab-content p-4 block">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
                <div class="flex items-center gap-3">
                    <div class="flex items-stretch shadow-sm rounded-lg overflow-hidden border border-slate-300 focus-within:ring-1 focus-within:ring-blue-500 focus-within:border-blue-500 transition-all">
            ...
            <div class="flex items-center justify-between mt-4 text-sm text-slate-500">
                <div class="flex items-center gap-2">
                    <span>Show</span>
                    <select class="bg-white border border-slate-300 rounded px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option>10</option>
                        <option>25</option>
                        <option>50</option>
                    </select>
                ...
                <div class="flex items-center gap-1">
                    <button class="px-3 py-1.5 border border-slate-200 text-slate-400 bg-slate-50 rounded-lg cursor-not-allowed">Previous</button>
                    <button class="px-3 py-1.5 border border-slate-200 text-slate-400 bg-slate-50 rounded-lg cursor-not-allowed">Next</button>
                </div>
            </div>
        </div>
