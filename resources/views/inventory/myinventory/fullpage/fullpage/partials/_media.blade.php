<div id="tab-media" class="tab-content hidden flex-col gap-6">
    ...
    <div class="card !mb-0 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
            <div class="form-group">
                ...
                <span class="sub-label">Issuing laboratory</span>
                <div class="relative w-full custom-select-wrapper">
                    <button type="button" class="form-control flex items-center pl-3 pr-8 text-left">
                        <span class="truncate text-slate-400 selected-text">Select lab</span>
                    </button>
            ...
            <div class="form-group">
                ...
                <span class="sub-label">Certificate report number</span>
                <input type="text" placeholder="Enter report number" class="form-control px-3">
            </div>
            <div class="form-group">
                <label>Certificate URL</label>
                <span class="sub-label">Link to online certificate</span>
                <input type="text" placeholder="https://" class="form-control px-3">
            </div>
            <div class="form-group">
                <label>Choose certificate file</label>
                <span class="sub-label">Upload PDF or Image</span>
                <label class="w-full h-[38px] border border-slate-200 border-dashed rounded-lg flex items-center justify-center cursor-pointer hover:bg-slate-50 transition-colors">
                    <input type="file" class="hidden">
                    <span class="text-blue-600 text-[13px] font-medium flex items-center gap-2"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg> Upload File</span>
                </label>
            </div>
        </div>
        <button type="button" class="mt-4 px-4 py-2 bg-blue-600 text-white text-[13px] font-semibold rounded-lg hover:bg-blue-700 transition-colors">Upload Certificate</button>

        <div class="mt-8 border border-slate-200 rounded-lg overflow-hidden">
            <table class="w-full text-left border-collapse">
                ...
                <tbody>
                    <tr>
                        <td class="p-3 text-center text-slate-400 text-[12px]" colspan="5">No certificates uploaded.</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="card !mb-0 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
            <div class="form-group">
                <label>Title *</label>
                <span class="sub-label">Add document title</span>
                <input type="text" placeholder="e.g. Invoice, Agreement" class="form-control px-3">
            </div>
            <div class="form-group">
                <label>Description</label>
                <span class="sub-label">Add short description</span>
                <input type="text" placeholder="Enter description" class="form-control px-3">
            </div>
            <div class="form-group">
                <label>Note File</label>
                <span class="sub-label">Choose File</span>
                <label class="w-full h-[38px] border border-slate-200 border-dashed rounded-lg flex items-center justify-center cursor-pointer hover:bg-slate-50 transition-colors">
                    <input type="file" class="hidden">
                    <span class="text-blue-600 text-[13px] font-medium flex items-center gap-2"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg> Upload File</span>
                </label>
        ...
        <button type="button" class="mt-4 px-4 py-2 bg-blue-600 text-white text-[13px] font-semibold rounded-lg hover:bg-blue-700 transition-colors">Upload Document</button>
        ...
        <div class="mt-8 border border-slate-200 rounded-lg overflow-hidden">
            <table class="w-full text-left border-collapse">
                ...
                <tbody>
                    <tr>
                        <td class="p-3 text-center text-slate-400 text-[12px]" colspan="4">No documents uploaded.</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="card !mb-0 shadow-sm">
        <h2 class="card-title">Add traceability info</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
            <div class="form-group">
                <label>Title *</label>
                <span class="sub-label">e.g. mining information</span>
                <input type="text" placeholder="Enter title" class="form-control px-3">
            </div>
            <div class="form-group">
                <label>Description</label>
                <span class="sub-label">Add description here</span>
                <input type="text" placeholder="Enter description" class="form-control px-3">
            </div>
            <div class="form-group">
                <label>Traceability File (2MB Max)</label>
                <span class="sub-label">Choose File</span>
                <label class="w-full h-[38px] border border-slate-200 border-dashed rounded-lg flex items-center justify-center cursor-pointer hover:bg-slate-50 transition-colors">
                    <input type="file" class="hidden">
                    <span class="text-blue-600 text-[13px] font-medium flex items-center gap-2"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg> Upload File</span>
        ...
        <button type="button" class="mt-4 px-4 py-2 bg-blue-600 text-white text-[13px] font-semibold rounded-lg hover:bg-blue-700 transition-colors">Upload Traceability Info</button>
        ...
        <div class="mt-8 border border-slate-200 rounded-lg overflow-hidden">
            <table class="w-full text-left border-collapse">
                ...
                <tbody>
                    <tr>
                        <td class="p-3 text-center text-slate-400 text-[12px]" colspan="4">No traceability info uploaded.</td>
                    </tr>
                </tbody>
            </table>
        </div>
