                ...
                <form id="createProductionForm" action="{{ route('production.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5">
                                ...
                                <div class="relative searchable-dropdown" id="ddMcCatWrapper">
                                    ...
                                    <div id="ddMcCatPanel"
                                        ...
                                        <ul class="py-1 max-h-48 overflow-y-auto custom-scrollbar">
                                            ...
                                            <li class="dd-option flex items-center px-4 py-2.5 text-[14px] cursor-pointer hover:bg-slate-50 text-slate-600"
                                                data-value="rough_gemstone" data-label="Rough Gemstone">Rough Gemstone</li>
                                            <li class="dd-option flex items-center px-4 py-2.5 text-[14px] cursor-pointer hover:bg-slate-50 text-slate-600"
                                                data-value="diamond" data-label="Diamond">Diamond</li>
                                            <li class="dd-option flex items-center px-4 py-2.5 text-[14px] cursor-pointer hover:bg-slate-50 text-slate-600"
                                                data-value="preform" data-label="Preform">Preform</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div id="ddMcSupplierPanel"
                                        ...
                                        <ul class="py-1 max-h-48 overflow-y-auto custom-scrollbar">
                                            @foreach($suppliers as $s)
                                                @if($s['value'] !== 'all')
                                                    <li class="dd-option flex items-center px-4 py-2.5 text-[14px] cursor-pointer hover:bg-slate-50 text-slate-600"
                                                        data-value="{{ $s['value'] }}" data-label="{{ $s['label'] }}">
                                                        {{ $s['label'] }}
                                                    </li>
                                                @endif
                                            @endforeach
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <div class="relative w-[85px] searchable-dropdown" id="ddMcWeightUnitWrapper">
                                        ...
                                        <button type="button" id="ddMcWeightUnitBtn"
                                            class="form-control flex items-center pl-3 pr-7 text-left bg-slate-50 cursor-not-allowed"
                                            disabled>
                            ...
                            <div>
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <input type="text" name="original_total_cost" placeholder="0.00" readonly
                                        class="form-control flex-1 px-3 bg-slate-50 cursor-not-allowed">
                                </div>
                            </div>
                    ...
                    <div id="mc-tab-items" class="mc-tab-content hidden px-6 py-6 pb-20">
                        ...
                        <div class="bg-slate-50 border border-slate-200 rounded-md p-4 mb-4">
                            ...
                            <div id="item-stock-warning"
                                class="hidden mt-3 flex items-start gap-2.5 bg-red-50 border border-red-200 rounded-md px-4 py-3">
                                <svg class="w-4 h-4 text-red-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <p id="item-stock-warning-text" class="text-[12px] text-red-700 font-medium leading-snug">
                                </p>
                            </div>
                        </div>
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar bg-white relative p-6">
                ...
                <div id="view-tab-details" class="view-tab-content block">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        ...
                        <div>
                            <span
                                class="block text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Supplier</span>
