...
@section('title', 'Quotation - GemExhibit')
        ...
        <div class="page-header-content py-3 d-flex align-items-center justify-content-between">
            <div>
                <h1 class="page-header-title font-weight-light mb-0 d-flex align-items-center">
                    <a href="{{ url('Sales/Quotations') }}" class="btn btn-sm btn-icon btn-light mr-2"><i data-feather="arrow-left"></i></a>
                    <span>QUO26060401</span>
                    <span class="badge badge-warning ml-2 font-weight-normal text-white" style="font-size: 12px;">Draft</span>
                </h1>
                <div class="text-muted small mt-1 ml-5 pl-2">Last updated: 04 Jun 2026 11:27:56 (0 seconds ago)</div>
            </div>
            <div>
                ...
                <div class="btn-group mr-1">
                    <button class="btn btn-primary btn-sm px-3">Save as draft</button>
                    <button type="button" class="btn btn-primary btn-sm dropdown-toggle dropdown-toggle-split" data-toggle="dropdown"></button>
                </div>
                <div class="btn-group mr-1">
                    <button class="btn btn-outline-primary btn-sm px-3 bg-white">Send</button>
                    <button type="button" class="btn btn-outline-primary btn-sm dropdown-toggle dropdown-toggle-split bg-white" data-toggle="dropdown"></button>
                </div>
...
<div class="container-fluid mt-3">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" value="QUO26060401">
                </div>
                <div class="col-md-3 form-group">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body text-center py-5 bg-light">
            <h5 class="font-weight-bold">Add items to Quotation</h5>
            <p class="text-muted small">This Quotation currently does not have any items in it.<br>Please add items to this Quotation.</p>
            <div class="mt-3">
                <button class="btn btn-outline-primary btn-sm mr-2"><i data-feather="maximize"></i> Scan / type to add</button>
                <button class="btn btn-outline-primary btn-sm"><i data-feather="plus"></i> Add from catalog</button>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body text-center py-4 bg-light">
            ...
            <p class="small text-muted mb-0">This Quotation currently does not have any items in it. Please add<br>items to this Quotation</p>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3 align-items-center">
                <span class="small text-muted">Created by Madushika sadamali on 4 Jun 2026 at 11:27 am.</span>
                <div class="d-flex">
