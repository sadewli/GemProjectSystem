...
@section('title', 'Invoice Detail - GemExhibit')
        ...
        <div class="page-header-content py-3 d-flex align-items-center justify-content-between flex-wrap">
            <div>
                <h1 class="page-header-title font-weight-light mb-0 d-flex align-items-center">
                    <a href="{{ url('Sales/Invoices') }}" class="btn btn-sm btn-icon btn-light mr-2"><i data-feather="arrow-left"></i></a>
                    <span>INV26060402</span>
                    <span class="badge badge-warning ml-2 font-weight-normal text-white" style="font-size: 12px;">Draft</span>
                </h1>
                <div class="text-muted small mt-1 ml-5 pl-2">Last updated: 04 Jun 2026 12:26:34 (2 seconds ago)</div>
            </div>
            <div>
...
<div class="container-fluid mt-3">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" value="INV26060402">
                </div>
                <div class="col-md-3 form-group">
                ...
                <div class="col-md-3 form-group">
                    ...
                    <input type="date" class="form-control form-control-sm" value="2026-06-11">
                </div>
            </div>
            <hr class="mt-0 mb-3">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-3 form-group mb-0 d-flex flex-column justify-content-center">
                    <label class="small font-weight-bold mb-1">Online payments:</label>
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="onlinePaymentsSwitch">
                        <label class="custom-control-label" for="onlinePaymentsSwitch">--</label>
                    </div>
                </div>
                <div class="col-md-3 form-group mb-0">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body text-center py-5 bg-light">
            <h5 class="font-weight-bold">Add items to Invoice</h5>
            <p class="text-muted small">This Invoice currently does not have any items in it.<br>Please add items to this Invoice.</p>
            <div class="mt-3">
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3 align-items-center">
                <span class="small text-muted">Created by Madushika sadamali on 4 Jun 2026 at 12:26 pm.</span>
                <div class="d-flex">
