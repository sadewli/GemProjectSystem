...
@section('title', 'Shipping Invoice - GemExhibit')
        ...
        <div class="page-header-content py-3 d-flex align-items-center justify-content-between">
            <div>
                <h1 class="page-header-title font-weight-light mb-0 d-flex align-items-center">
                    <a href="{{ url('Sales/ShippingInvoices') }}" class="btn btn-sm btn-icon btn-light mr-2"><i data-feather="arrow-left"></i></a>
                    <span>GS-Doc26060401</span>
                    <span class="badge badge-warning ml-2 font-weight-normal text-white" style="font-size: 12px;">Draft</span>
                </h1>
                <div class="text-muted small mt-1 ml-5 pl-2">Last updated: 04 Jun 2026 11:50:00 (0 seconds ago)</div>
            </div>
            <div>
...
<div class="container-fluid mt-3">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 form-group">
                    <label class="small font-weight-bold">Shipping invoice id:</label>
                    <input type="text" class="form-control form-control-sm" value="GS-Doc26060401">
                </div>
                <div class="col-md-3 form-group">
                ...
                <div class="col-md-3 form-group">
                    <label class="small font-weight-bold">Shipping date:</label>
                    <input type="date" class="form-control form-control-sm" placeholder="Select shipping date">
                </div>
            </div>
            <div class="row">
                <div class="col-md-3 form-group">
            ...
            <div class="row">
                <div class="col-md-3 form-group">
                    <label class="small font-weight-bold">Courier:</label>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body text-center py-5 bg-light">
            <h5 class="font-weight-bold">Add items to Shipping Invoice</h5>
            <p class="text-muted small">This Shipping Invoice currently does not have any items in it.<br>Please add items to this Shipping Invoice.</p>
            <div class="mt-3">
    ...
    <div class="row mb-4">
        <div class="col-md-7">
            ...
            <div class="form-group">
                <label class="font-weight-bold small">Note to receiver</label>
                <textarea class="form-control" rows="4" placeholder="Add a note to your receiver"></textarea>
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body text-center py-4 bg-light">
            ...
            <p class="small text-muted mb-0">This Shipping Invoice currently does not have any items in it. Please add<br>items to this Shipping Invoice</p>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3 align-items-center">
                <span class="small text-muted">Created by Madushika sadamali on 4 Jun 2026 at 11:50 am.</span>
                <div class="d-flex">
