...
@section('title', 'Purchase Orders - GemExhibit')
...
<div class="page-header page-header-light bg-white shadow-sm mb-4">
    <div class="container-fluid">
        <div class="page-header-content py-3 d-flex align-items-center justify-content-between flex-wrap">
            <div>
                <h1 class="page-header-title font-weight-light mb-1">Purchase orders</h1>
                <div class="text-muted small">Last updated: 2026-06-04 12:11:41 (just now)</div>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md col-sm-4 col-6 mb-2">
            <div class="card shadow-sm h-100" style="border-left: 4px solid #007bff;">
                <div class="card-body p-2">
                    ...
                    <div class="small text-muted mb-1" style="font-size: 11px;">items: 2</div>
        ...
        <div class="col-md col-sm-4 col-6 mb-2">
            <div class="card shadow-sm h-100" style="border-left: 4px solid #17a2b8;">
                <div class="card-body p-2">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <span class="font-weight-bold text-info small">Awaiting payment</span>
                        <input type="checkbox">
                    </div>
        ...
        <div class="col-md col-sm-4 col-6 mb-2">
            <div class="card shadow-sm h-100" style="border-left: 4px solid #28a745;">
                <div class="card-body p-2">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <span class="font-weight-bold text-success small">Paid</span>
                        <input type="checkbox">
                    </div>
                    <div class="small text-muted mb-1" style="font-size: 11px;">items: 0</div>
                    <div class="font-weight-bold small">USD: $0.00</div>
        ...
        <div class="col-md col-sm-4 col-6 mb-2">
            <div class="card shadow-sm h-100" style="border-left: 4px solid #dc3545;">
                <div class="card-body p-2">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <span class="font-weight-bold text-danger small">Voided</span>
                        <input type="checkbox">
                    </div>
                    <div class="small text-muted mb-1" style="font-size: 11px;">items: 0</div>
                    <div class="font-weight-bold small">USD: $0.00</div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
        <button class="btn btn-outline-secondary btn-sm mb-2"><i data-feather="columns" class="mr-1"></i> Columns visibility</button>
        <div class="d-flex mb-2">
            ...
            <a href="{{ url('Sales/PurchaseOrders/new') }}" class="btn btn-primary btn-sm">
                <i data-feather="plus" class="mr-1"></i> Create new PO
            </a>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-sm text-nowrap mb-0 align-middle">
                <thead class="bg-light">
                    <tr>
                        <th>PO # <i data-feather="chevron-down" style="width: 14px;"></i></th>
                        <th>Reference</th>
                        <th>Supplier <i data-feather="chevron-down" style="width: 14px;"></i></th>
                        <th>Issue date <i data-feather="chevron-down" style="width: 14px;"></i></th>
                        <th>Due date <i data-feather="chevron-down" style="width: 14px;"></i></th>
                        <th class="text-right">Paid <i data-feather="chevron-down" style="width: 14px;"></i></th>
                        <th class="text-right">Due <i data-feather="chevron-down" style="width: 14px;"></i></th>
                        <th>Status</th>
                ...
                <tbody>
                    <tr>
                        <td><a href="{{ url('Sales/PurchaseOrders/PO26042801') }}" class="font-weight-bold text-primary">PO26042801</a></td>
                        <td>test</td>
                        <td>Comp-1</td>
                    ...
                    <tr>
                        <td><a href="{{ url('Sales/PurchaseOrders/PO26042201') }}" class="font-weight-bold text-primary">PO26042201</a></td>
                        ...
                        <td class="text-right">0</td>
                        <td class="text-right">0.00 ct</td>
                        <td class="text-center"><span class="badge badge-success font-weight-normal text-white">Y</span></td>
                    </tr>
                </tbody>
            </table>
        </div>
