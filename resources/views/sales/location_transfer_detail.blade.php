...
@section('title', 'Location Transfer Detail - GemExhibit')
        ...
        <div class="page-header-content py-3 d-flex align-items-center justify-content-between">
            <div>
                <h1 class="page-header-title font-weight-light mb-0 d-flex align-items-center">
                    <a href="{{ url('Sales/LocationTransfer') }}" class="btn btn-sm btn-icon btn-light mr-2"><i data-feather="arrow-left"></i></a>
                    <span>TR26060402</span>
                    <span class="text-muted font-weight-normal ml-2" style="font-size: 14px;">(Company To Company)</span>
                    <span class="badge badge-warning ml-2 font-weight-normal text-white" style="font-size: 12px;">Draft</span>
                </h1>
                <div class="text-muted small mt-1 ml-5 pl-2">Last updated: 04 Jun 2026 12:00:35 (0 seconds ago)</div>
            </div>
            <div>
...
<div class="container-fluid mt-3">
    ...
    <!-- Row 1: Transfer #, Requested By, Issue date, Due date -->
    <div class="card shadow-sm mb-3">
        <div class="card-body pb-2">
            <div class="row">
                <div class="col-md-3 form-group">
                    <label class="small font-weight-bold">Transfer #:</label>
                    <input type="text" class="form-control form-control-sm" value="TR26060402">
                </div>
                <div class="col-md-3 form-group">
            ...
            <hr class="mt-0 mb-3">
            <!-- Row 2: My company, Company from, Company to, Company Location -->
            <div class="row">
                <div class="col-md-3 form-group">
                    <label class="small font-weight-bold">My company:</label>
                    <select class="form-control form-control-sm"><option>svtd</option></select>
                </div>
                <div class="col-md-3 form-group">
                    <label class="small font-weight-bold">Company from:</label>
                    <select class="form-control form-control-sm"><option>Select company from</option></select>
                </div>
                <div class="col-md-3 form-group">
                    <label class="small font-weight-bold">Company to:</label>
                    <select class="form-control form-control-sm"><option>Select location to</option></select>
                </div>
                <div class="col-md-3 form-group">
                    <label class="small font-weight-bold">Company Location:</label>
                    <select class="form-control form-control-sm"><option>Select comp. loc.</option></select>
                </div>
            </div>
            <hr class="mt-0 mb-3">
            <!-- Row 3: Received by, Expected date -->
            <div class="row">
                <div class="col-md-3 form-group mb-0">
                    <label class="small font-weight-bold">Received by:</label>
                    <select class="form-control form-control-sm"><option>Select received by</option></select>
                </div>
                <div class="col-md-3 form-group mb-0">
                    <label class="small font-weight-bold">Expected date:</label>
                    <input type="date" class="form-control form-control-sm" value="2026-06-04">
                </div>
            </div>
        </div>
    ...
    <!-- Row 4: Auto-populate price, Currency, Exchange Rate -->
        ...
        <div class="card-body pb-2">
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <select class="form-control form-control-sm"><option>Venezuelan Bolívar Fuerte</option></select>
                </div>
            </div>
            <hr class="mt-0 mb-3">
            <div class="row">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body text-center py-5 bg-light">
            <h5 class="font-weight-bold">Add items to transfer document</h5>
            <p class="text-muted small">This transfer document currently does not have any items in it.<br>Please add items to this transfer document.</p>
            <div class="mt-3">
    ...
    <div class="row mb-4">
        <div class="col-md-7">
            ...
            <div class="form-group">
                ...
                <select class="form-control form-control-sm"><option>Choose Bank</option></select>
            </div>
            <div class="form-group">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="form-group row no-gutters align-items-center mb-2">
                        ...
                        <div class="col-sm-3 px-1"><input type="number" class="form-control form-control-sm" value="0"></div>
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body text-center py-4 bg-light">
            ...
            <p class="small text-muted mb-0">This Invoice currently does not have any items in it. Please add<br>items to this Invoice</p>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3 align-items-center">
                <span class="small text-muted">Created by Madushika sadamali on 4 Jun 2026 at 12:00 pm.</span>
                <div class="d-flex">
            ...
            <div class="table-responsive">
                <table class="table table-sm mb-0 border">
                    ...
                    <tbody>
                        <tr>
                            <td>2026-06-04 12:00:35</td>
                            <td>Madushika sadamali</td>
                            <td>Vendor</td>
                            <td>Created By</td>
                            <td>Created By...</td>
                            <td>Manual Update</td>
