...
@section('title', 'Supplier Memo Detail - GemExhibit')
        ...
        <div class="page-header-content py-3 d-flex align-items-center justify-content-between flex-wrap">
            <div>
                <h1 class="page-header-title font-weight-light mb-0 d-flex align-items-center">
                    <a href="{{ url('Sales/SupplierMemos') }}" class="btn btn-sm btn-icon btn-light mr-2"><i data-feather="arrow-left"></i></a>
                    <span>SMEMO26060402</span>
                    <span class="badge badge-warning ml-2 font-weight-normal text-white" style="font-size: 12px;">Draft</span>
                </h1>
                <div class="text-muted small mt-1 ml-5 pl-2">Last updated: 04 Jun 2026 12:19:55 (1 second ago)</div>
            </div>
            <div>
...
<div class="container-fluid mt-3">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 form-group">
                    <label class="small font-weight-bold">Supplier Memo:</label>
                    <input type="text" class="form-control form-control-sm" value="SMEMO26060402">
                </div>
                <div class="col-md-3 form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-3 form-group">
                    ...
                    <select class="form-control form-control-sm"><option>Cost Price</option></select>
                </div>
                <div class="col-md-3 form-group">
    ...
    <!-- Tabs -->
    <ul class="nav nav-tabs mb-4" id="supplierMemoTabs" role="tablist">
        <li class="nav-item flex-fill text-center">
            <a class="nav-link active font-weight-bold py-3" id="current-tab" data-toggle="tab" href="#current" role="tab" aria-controls="current" aria-selected="true">
                <u style="text-underline-offset: 4px;">Current (0)</u>
            </a>
        </li>
        <li class="nav-item flex-fill text-center">
            <a class="nav-link text-muted py-3" id="returned-tab" data-toggle="tab" href="#returned" role="tab" aria-controls="returned" aria-selected="false">
                Returned & purchased (0)
            </a>
        </li>
    </ul>

    <div class="tab-content" id="supplierMemoTabsContent">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3 align-items-center">
                        <span class="small text-muted">Created by Madushika on 4 Jun 2026 at 12:19 pm.</span>
                        <div class="d-flex">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm mb-0 border text-center">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm mb-0 border text-center">
                            <thead class="bg-light">
                                <tr>
                                    <th>Action <i data-feather="chevron-up" style="width: 14px;"></i></th>
                                    <th>Date/Time</th>
                                    <th>Updated By</th>
                                    <th>Total Rows</th>
                                    <th>Added</th>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="10" class="py-4 text-muted small">This List has not had any changes made to it</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
