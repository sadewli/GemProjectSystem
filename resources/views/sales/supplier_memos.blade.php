...
@section('title', 'Supplier Memo Overview - GemExhibit')
...
<div class="page-header page-header-light bg-white shadow-sm mb-4">
    <div class="container-fluid">
        <div class="page-header-content py-3 d-flex align-items-center justify-content-between flex-wrap">
            <div>
                <h1 class="page-header-title font-weight-light mb-1">Supplier memo overview</h1>
                <div class="text-muted small">Last updated: 2026-04-22 16:35:55 (1 month ago)</div>
            </div>
            <div>
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md col-sm-4 col-6 mb-2">
            <div class="card shadow-sm h-100" style="border-left: 4px solid #17a2b8;">
                <div class="card-body p-2">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <span class="font-weight-bold text-info small">Memo in</span>
                        <input type="checkbox">
                    </div>
        ...
        <div class="col-md col-sm-4 col-6 mb-2">
            <div class="card shadow-sm h-100" style="border-left: 4px solid #28a745;">
                <div class="card-body p-2">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <span class="font-weight-bold text-success small">Purchased</span>
                        <input type="checkbox">
                    </div>
                    <div class="small text-muted mb-1" style="font-size: 11px;">items: 0</div>
                    <div class="font-weight-bold small">USD: $0.00</div>
        ...
        <div class="col-md col-sm-4 col-6 mb-2">
            <div class="card shadow-sm h-100" style="border-left: 4px solid #6c757d;">
                <div class="card-body p-2">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <span class="font-weight-bold text-secondary small">Returned to supplier</span>
                        <input type="checkbox">
                    </div>
                    <div class="small text-muted mb-1" style="font-size: 11px;">items: 0</div>
                    <div class="font-weight-bold small">USD: $0.00</div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
        ...
        <div class="d-flex mb-2">
            ...
            <a href="{{ url('Sales/SupplierMemos/new') }}" class="btn btn-primary btn-sm">
                <i data-feather="plus" class="mr-1"></i> Create new memo
            </a>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-sm text-nowrap mb-0 align-middle">
                <thead class="bg-light">
                    <tr>
                        <th>Supplier memo # <i data-feather="chevron-down" style="width: 14px;"></i></th>
                        <th>Reference</th>
                        ...
                        <th>Expiry date</th>
                        <th>Status <i data-feather="chevron-down" style="width: 14px;"></i></th>
                        <th class="text-right">Quantity</th>
                        <th class="text-right">Weight</th>
                        <th class="text-right">Amount <i data-feather="chevron-down" style="width: 14px;"></i></th>
                        <th class="text-center">Sent</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td><a href="{{ url('Sales/SupplierMemos/SMEMO26042202') }}" class="font-weight-bold text-primary">SMEMO26042202</a></td>
                    ...
                    <tr>
                        <td><a href="{{ url('Sales/SupplierMemos/SMEMO26042201') }}" class="font-weight-bold text-primary">SMEMO26042201</a></td>
                        <td class="text-muted">--</td>
                        <td class="text-muted">--</td>
                        <td>22 April 2026</td>
                        <td class="text-muted">--</td>
