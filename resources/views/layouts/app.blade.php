...
<head>
    ...
    <!--begin::SB Admin & Custom Styles (mandatory for legacy page content layouts)-->
    <link href="{{ asset('css/styles.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('css/custom_styles.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('css/bootstrap-datetimepicker.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('css/full_calendar.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <!--begin::Vite (mandatory for Tailwind CSS & JS logic used in CRM/modern views)-->
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
                    ...
                    <div id="kt_app_footer" class="app-footer">
                        ...
                        <div
                            ...
                            <div class="text-gray-900 order-2 order-md-1">
                                ...
                                <a href="https://erav.lk" target="_blank" class="text-gray-800 text-hover-primary">eRav
                                    Technology</a>
                            </div>
                            <!--end::Copyright-->
                            <!--begin::Menu-->
                            <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                                ...
                                <li class="menu-item">
                                    <a href="https://devs.erav.lk" target="_blank" class="menu-link px-2">Support</a>
                                </li>
                            </ul>
                            <!--end::Menu-->
                        </div>
    ...
    <!-- Feather Icons library & auto-replace initialization -->
