...
@section('style')
    <style>
        .dashboard-summary-card .card-body { min-height: 130px; }
        .dashboard-summary-card .icon-circle { width: 48px; height: 48px; display: inline-flex; align-items: center; justify-content: center; border-radius: 50%; font-size: 18px; }
        .dashboard-hero { background: linear-gradient(135deg, rgba(14, 82, 160, 0.95), rgba(37, 121, 205, 0.92)); color: #fff; }
        .dashboard-hero .btn-outline-light { border-color: rgba(255,255,255,0.35); }
    </style>
@endsection
            ...
            <div class="card-body p-4">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <a href="{{ url('Distributor/GRN') }}" class="btn btn-light btn-sm mr-2">New GRN</a>
