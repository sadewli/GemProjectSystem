...
return new class extends Migration {
    ...
    {
        DB::statement("
            CREATE TABLE IF NOT EXISTS `tbl_color_grade` (
                `idtbl_color_grade`   INT(11)      NOT NULL AUTO_INCREMENT,
                `idtbl_product_types` INT(11)      NOT NULL,
                `grade_name`          VARCHAR(50)  NOT NULL COLLATE utf8mb4_general_ci,
    ...
    {
        DB::statement('DROP TABLE IF EXISTS `tbl_color_grade`');
    }
};
